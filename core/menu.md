...
3️⃣  数据库搭建 — 产业数据库 / 公司数据库 / Excel 指标库
4️⃣  投资命题构建 — 定义核心矛盾、拆解研究问题

📈 财报类
5️⃣  财报前瞻 — 关注点、beat/miss 路径、指引听点
6️⃣  财务模型校验 — 假设审阅、敏感性分析、断裂点

🔍 跟踪类
7️⃣  一致预期监控 — 预期差挖掘、估值锚变化
8️⃣  催化剂跟踪 — 事件/政策/订单/价格驱动
9️⃣  路演问题设计 — 调研提纲、业绩会高价值问题

⚔️ 风控类
🔟  反方论证 (Red Team) — 挑战多头逻辑、找证伪点

📋 输出类
1️⃣1️⃣ 基金经理摘要 (PM Brief) — 一页纸决策摘要
1️⃣2️⃣ 投研简报 — 晨会纪要、收盘复盘、调研纪要

⚡ 批量类（v0.3 新增）
1️⃣3️⃣ 覆盖池批量刷新 — 行情/财务/股东/催化一次更
1️⃣4️⃣ 财报季批量前瞻 — 一周内多家财报排队前瞻
1️⃣5️⃣ 每日催化剂扫描 — 晨会前 30 分钟扫一遍覆盖池

🤖 自动模式
1️⃣6️⃣ Autopilot — 给我一个公司名/行业/事件，自动跑全流程
1️⃣7️⃣ Master 模式 — 7 种工作模式自动识别，一个 skill 搞定
...
| 3 | sm-industry-database | 产业 / 公司数据库搭建 |
| 4 | sm-thesis | 投资命题构建 |
| 5 | sm-earnings-preview | 财报前瞻 |
| 6 | sm-model-check | 财务模型校验 |
| 7 | sm-consensus-watch | 一致预期监控 |
| 8 | sm-catalyst-monitor | 催化剂跟踪 |
| 9 | sm-roadshow-questions | 路演问题设计 |
| 10 | sm-red-team | 反方论证 |
| 11 | sm-pm-brief | PM 一页纸 |
| 12 | sm-briefing | 投研简报 |
| 13 | sm-batch-refresh | 覆盖池批量刷新 |
| 14 | sm-batch-earnings | 财报季批量前瞻 |
...
| 21 | sm-learn | 自主学习（自动归纳你的提问方式反补进 skill；关键词仅手动操作用，v0.9.7）|
...
- 出现 "归纳提问 / 学习我的问法 / 把这些问题学进去 / 看看学了什么 / 撤销 L-" → sm-learn
