...
回看本次输出的每一段。每一条"事实陈述"必须有完整中文证据标签之一：
...
1. **在对话里贴出完整输出** — 给用户直接读，包括全部段落内容、证据等级、仍需补的资料、合规声明
...
📊 文件大小：12.4 KB · 段落数：9/9 · 证据：公开事实×8 财报披露×15 市场共识×6 合理推演×9 待核验假设×4
