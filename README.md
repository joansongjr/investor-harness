...
> **越用越懂你——而且这份"懂"完全属于你的本地工作区，可审计、可回滚、可迁移。**
...
- **产业链位置**：AI 芯片设计公司（fabless），采用台积电代工 (财报披露-公司年报)
- **产品结构**：
  - 云端训练卡：思元 370（对标 A100 级别，7nm）(财报披露)
  - 云端推理卡：思元 590（对标 H100 级别，已流片）(财报披露-2024 年报)
  - 边缘 / 终端：占比小，2024 收入贡献 < 10% (财报披露)
- **差异化**：
  - vs 海光：海光是 x86 通用 CPU + DCU，寒武纪是纯 AI 专用 ASIC
  - vs 华为昇腾：昇腾绑定华为生态，寒武纪相对中立
  - vs 摩尔线程：摩尔线程 GPU 架构更通用，寒武纪指令集更定制 (合理推演-基于公开技术文档推演)

## 2. 业务拆分（FY2024）

| 业务线 | 收入占比 | YoY | 毛利率 | 证据 |
|---|---|---|---|---|
| 云端产品线 | ~85% | [需补] | [需补] | 财报披露-年报披露但口径模糊 |
| 边缘 | ~10% | [需补] | [需补] | 财报披露 |
| 终端 | ~5% | [需补] | [需补] | 财报披露 |
...
核心假设链：
1. **量**：思元 590 2025 H2 起量 → 2026 全年贡献 (合理推演-基于公司公告的流片时点推演)
2. **价**：国产 AI 卡当前 ASP 约 H100 的 60-70% (市场共识-卖方一致预期)，2026 可能承压（竞争加剧）
3. **结构**：训练卡占比上升 → 收入单价提升 (合理推演)
4. **客户**：互联网大厂为主（字节、阿里云、腾讯云）(待核验假设-渠道传闻，**未经核验**)

## 4. 利润驱动

- **毛利率**：2024 约 [XX]% (财报披露)，高于设计公司行业均值
  - 驱动：缺乏国产替代品 → 议价能力强 (合理推演)
  - 风险：2026 随供给增加回落到 [XX]% (合理推演-卖方一致预期)
- **研发费用率**：持续高位（2024 约 [XX]%, 财报披露），短期不会下降
- **经营杠杆**：收入规模到 [XX] 亿元后显著 (合理推演)
- **归母净利**：2024 仍亏损 (财报披露)，预计 2025-2026 扭亏时点是核心预期差来源

## 5. 核心竞争力 / 风险点

**竞争力**（带验证路径）：
1. **国产化稀缺性** (公开事实) — 验证：看美国对华出口管制是否覆盖 H20 等降级卡
2. **自主指令集 + 软件栈** (财报披露-招股书) — 验证：看客户是否愿意为适配成本买单
3. **流片节奏** (财报披露-公告) — 验证：看思元 590 的量产良率

**风险**（可观测、可触发）：
1. **客户集中度过高** — 前五大客户占 > 70% (财报披露-年报)
   → 触发：任何头部客户切换到昇腾或自研 → 直接下修
2. **思元 590 良率不及预期** — 7nm 以下良率敏感
   → 触发：2025 Q2/Q3 出货量显著低于公司指引 → 下修
3. **美国出口管制放松** — H20 / MI325 重新大量进入中国 → 国产替代逻辑弱化
   → 触发：关注 BIS 公告
4. **公司持续亏损、现金流压力** — 现金储备仅支撑 N 个季度 (财报披露-需补最新季报)
   → 触发：定增或债券发行
...
- 2025 能否扭亏 (市场共识)
- 思元 590 量产进度 (市场共识)
- 国内云厂商 AI capex 指引 (市场共识)

**当前市场共识**：乐观，2024 股价已反映部分扭亏预期 (市场共识)
**潜在预期差**：
...
真正决定股价方向的是**2026 毛利率能否守住 20%** 和 **capex 节奏是否收敛**。(合理推演)
...
**多头证据**：Meta/Microsoft/Google/AWS 2024 capex 合计 [XXX] 亿美元，2025 指引继续 +30% (财报披露)

**为什么脆弱**：
- 这些公司的经营现金流支撑 capex 的能力有上限，FCF / capex 比率已从 2020 的 2.5x 降到 2024 的 [X]x (财报披露-财报推算)
- 2024 股东回报（回购 + 分红）的优先级仍高于 capex，董事会压力在累积 (市场共识-股东信)
- 如果 2026 某季度**任意一家**把 capex 指引下修 → 板块整体杀估值（历史上云计算 capex 周期就是这样） (合理推演)
...
- 当模型能力达到某个阈值（GPT-5 / Claude Opus 4.6 级别）后，**边际效用递减**可能压低下一轮训练投入的 ROI (待核验假设-待观察)
...
**多头证据**：国产卡产能有限，性能差距仍大 (公开事实)

**为什么脆弱**：
- 美国出口管制持续收紧 → 中国厂商**被迫**加速自研 → 寒武纪 / 华为昇腾 / 海光的 2026 出货可能大超预期
- 中国云厂商的采购意愿从"性能优先"转向"可获得性优先"
- NVIDIA 的中国收入 2024 已是历史低点，但 2025 H20 若继续被禁 → 归零 (财报披露-需补)
...
| 多头主张 | 实际证据 | 差距 |
|---|---|---|
| "AI capex 持续超预期" | Hyperscaler capex 指引 (财报披露) | 只到 2025，2026 没指引 |
| "训练需求持续增长" | 模型能力提升轨迹 (合理推演) | 无法证明需求斜率 |
| "效率提升不足以抵消需求" | [无明确证据] | 🔴 空白 |
| "GPU 供给紧张" | NVIDIA 财报 (财报披露) | 2024 已显著缓解 |
...
2. **确认偏差** — ⚠️ 命中
   你的多头命题里引用的证据 80% 来自 Hyperscaler 官方指引（市场共识-公司口径），缺少独立第三方验证
...
| `sm-people-watch` | 关键人物 / X / Reddit / 社区信号流追踪，和股票池 / 主题联动 |
...
### 自主学习 skill（v0.9.7 新增）

| Skill | 适用场景 |
|---|---|
| `sm-learn` | **自主学习** — 自动采集你的提问 / 追问 / 纠正，每 3-5 次会话自动归纳，按"问题回家"原则反补进对应 skill 的必答问题（overlay）；自动生效进试用期，你只保留"撤销 L-xxx"否决权。协议见 [`core/learning.md`](core/learning.md) |
...
> ⚠️ **关键最后一步**：装好 skills 之后还需要激活入口 MD。v0.9.1 起**推荐**直接说 **"跑一下 investor-harness onboarding"**，让 agent 自动把路由写入对应入口文件（Claude Code → `~/.claude/CLAUDE.md`；Codex → `~/.codex/AGENTS.md`；OpenCode → `~/.config/opencode/AGENTS.md`）。详见 [`INSTALL-PROMPT.md`](INSTALL-PROMPT.md)。
...
会生成一套分析师工作区模板：`CLAUDE.md`（Claude Code / OpenClaw）+ `AGENTS.md`（Codex / OpenCode）+ `memory.md` / `coverage.md` / `decision-log.md` / `biases.md` / `research-queue.md` / **active-tasks.md**，并同时建好 `coverage/` / `themes/` / `briefings/` / `.task-pulse` / `.checkpoint/` 等归档骨架，避免"路由装好了、书架却是空的"。
