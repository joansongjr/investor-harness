# Investor Harness · 保守升级提示词（v0.9.6）
...
> **"读 `~/investor-harness/UPGRADE-PROMPT.md`，然后帮我把本地 investor-harness 保守升级到 v0.9.6，保留我的个性化设置和任务底稿。"**
...
4. **目标版本**
   - 如果仓库存在显式 `v0.9.6` tag，则以 tag 为准
   - 如果没有显式 tag，则以 `README.md` / `ONBOARDING.md` / marker 中显示为 `v0.9.6` 的最新仓库状态为准
...
- **"读 `~/investor-harness/UPGRADE-PROMPT.md`，帮我保守升级到 v0.9.6。"**
- **"按 investor-harness 的保守升级规则，把我本地版本升级到 v0.9.6，保留我的配置和任务底稿。"**
