# Investor Harness · 保守升级提示词（v0.9.8）
...
> **"读 `~/investor-harness/UPGRADE-PROMPT.md`，然后帮我把本地 investor-harness 保守升级到 v0.9.8，保留我的个性化设置和任务底稿。"**
